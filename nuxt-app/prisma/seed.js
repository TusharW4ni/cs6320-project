...
async function main() {
  ...
  const recipe = await prisma.recipe.create({
    data: {
      ...
      Ingredients: {
        create: [
          { name: "1 poblano pepper or green bell pepper, (kept whole)" },
          { name: "3 tablespoons olive oil or avocado oil, (divided)" },
          { name: "1 medium yellow or red onion, (finely chopped)" },
          { name: "4 garlic cloves, (chopped)" },
          { name: "2 tablespoons tomato paste" },
          { name: "1 ½ teaspoons ground cumin" },
          { name: "1 teaspoon Mexican oregano (or regular oregano)" },
          { name: "½ teaspoon ancho chile powder" },
          { name: "1 ½ teaspoons kosher salt, (divided)" },
          { name: "A generous amount of freshly cracked black pepper" },
          {
            name: "1 (12 to 16-ounce) block of super firm tofu (also sold as high-protein tofu)*",
          },
          { name: "2 roma tomatoes, (chopped)" },
          { name: "1 chipotle pepper in adobo + 1/2 tablespoon adobo sauce**" },
          { name: "2 teaspoons red wine vinegar" },
          { name: "½ cup (120 mL) water" },
          { name: "Lime juice (to finish)" },
        ],
      },
      Directions: {
        create: [
