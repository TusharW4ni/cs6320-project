...
def main(
    documents_directory: str = "notion-docs",
    collection_name: str = "notion_api_docs_default_google",
    persist_directory: str = "chroma_db_default_embeddings_google",
) -> None:
...
if __name__ == "__main__":
    ...
    main(
        documents_directory="notion-docs",
        collection_name="notion_api_docs_default_google",
